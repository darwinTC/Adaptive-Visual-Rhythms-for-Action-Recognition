...
__all__ = ['ResNet', 'rhythm_resnet18', 'rhythm_resnet34', 'rhythm_resnet50', 'rhythm_resnet50_aux', 'rhythm_resnet101', 'rhythm_resnet152']
...
def rhythm_resnet18(pretrained=False, **kwargs):
...
def rhythm_resnet34(pretrained=False, **kwargs):
...
def rhythm_resnet50(pretrained=False, **kwargs):
...
def rhythm_resnet50_aux(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
...
def rhythm_resnet101(pretrained=False, **kwargs):
...
def rhythm_resnet152(pretrained=False, **kwargs):
